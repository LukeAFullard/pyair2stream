...
| | |
|---|---|
| Date | 2026-09-25 12:44 UTC |
| pyair2stream | 0.4.0, commit 4b213a5 at the start of the run |
| Mode | full |
| Run time | 48.0 minutes |
| Python | 3.11.15 |
...
| Mentue | 5 | 0.6664 | 0.6674, 0.6664, 0.6664 | 2 of 3 | 0.6664, 0.6664, 0.6665 | 3 of 3 | 0.6664 |
| Mentue | 7 | 0.6371 | 0.6587, 0.6458, 0.6345 | 0 of 3 | 0.6559, 0.6392, 0.6582 | 0 of 3 | 0.6336 |
| Mentue | 8 | 0.645 | 0.6434, 0.6481, 0.6489 | 0 of 3 | 0.6654, 0.6576, 0.6589 | 0 of 3 | 0.6331 |
| Rhône | 3 | 0.9072 | 0.9072, 0.9072, 0.9072 | 3 of 3 |  |  | 0.9073 |
| Rhône | 4 | 0.9065 | 0.9065, 0.9065, 0.9065 | 2 of 3 |  |  | 0.9065 |
| Rhône | 5 | 0.8707 | 0.8707, 0.8707, 0.8708 | 2 of 3 |  |  | 0.8707 |
| Rhône | 7 | 0.5787 | 0.5795, 0.5799, 0.5788 | 0 of 3 |  |  | 0.578 |
| Rhône | 8 | 0.5792 | 0.5821, 0.5820, 0.5793 | 0 of 3 |  |  | 0.5775 |
...
| Dischmabach | 7 | 0.6349 | 0.6349, 0.6349, 0.6350 | 2 of 3 |  |  | 0.6349 |
...
| Mentue | 5 | original program (Fortran PSO), run 1 | 3.433 | 0.716 | 1.096 |  |  | 1.825 | 0.582 |  | 0.6674 |
| Mentue | 5 | original program (Fortran PSO), run 2 | 3.110 | 0.673 | 1.019 |  |  | 1.641 | 0.583 |  | 0.6664 |
| Mentue | 5 | original program (Fortran PSO), run 3 | 3.092 | 0.670 | 1.014 |  |  | 1.627 | 0.583 |  | 0.6664 |
...
| Mentue | 7 | original program (Fortran PSO), run 1 | 1.139 | 0.982 | 1.139 |  | 5.409 | 3.590 | 0.596 | 0.562 | 0.6587 |
| Mentue | 7 | original program (Fortran PSO), run 2 | 1.022 | 0.882 | 1.027 |  | 4.124 | 2.732 | 0.600 | 0.422 | 0.6458 |
| Mentue | 7 | original program (Fortran PSO), run 3 | 0.923 | 0.721 | 0.844 |  | 3.085 | 2.035 | 0.600 | 0.320 | 0.6345 |
...
| Mentue | 8 | original program (Fortran PSO), run 1 | 1.131 | 0.878 | 1.030 | -0.103 | 4.195 | 2.787 | 0.599 | 0.430 | 0.6434 |
| Mentue | 8 | original program (Fortran PSO), run 2 | 1.202 | 0.955 | 1.117 | -0.196 | 4.668 | 3.107 | 0.597 | 0.481 | 0.6481 |
| Mentue | 8 | original program (Fortran PSO), run 3 | 1.077 | 0.929 | 1.080 | -0.163 | 4.982 | 3.265 | 0.596 | 0.510 | 0.6489 |
...
| Rhône | 4 | original program (Fortran PSO), run 1 | 12.911 | 0.722 | 2.913 | -0.336 |  |  |  |  | 0.9065 |
| Rhône | 4 | original program (Fortran PSO), run 2 | 13.185 | 0.737 | 2.975 | -0.351 |  |  |  |  | 0.9065 |
| Rhône | 4 | original program (Fortran PSO), run 3 | 13.021 | 0.728 | 2.938 | -0.342 |  |  |  |  | 0.9065 |
| Rhône | 4 | pyair2stream DE | 12.921 | 0.722 | 2.915 | -0.337 |  |  |  |  | 0.9065 |
| Rhône | 5 | published | 15.000 | 0.551 | 2.966 |  |  | 2.257 | 0.491 |  | 0.8707 |
| Rhône | 5 | original program (Fortran PSO), run 1 | 14.831 | 0.546 | 2.933 |  |  | 2.224 | 0.490 |  | 0.8707 |
| Rhône | 5 | original program (Fortran PSO), run 2 | 15.000 | 0.551 | 2.966 |  |  | 2.257 | 0.491 |  | 0.8707 |
| Rhône | 5 | original program (Fortran PSO), run 3 | 13.610 | 0.503 | 2.695 |  |  | 2.032 | 0.490 |  | 0.8708 |
...
| Rhône | 7 | original program (Fortran PSO), run 1 | 0.338 | 0.486 | 0.326 |  | 19.247 | 5.412 | 0.530 | 3.126 | 0.5795 |
| Rhône | 7 | original program (Fortran PSO), run 2 | 0.559 | 0.509 | 0.366 |  | 19.643 | 5.648 | 0.531 | 3.211 | 0.5799 |
| Rhône | 7 | original program (Fortran PSO), run 3 | 0.853 | 0.461 | 0.391 |  | 16.456 | 4.784 | 0.529 | 2.712 | 0.5788 |
...
| Rhône | 8 | original program (Fortran PSO), run 1 | 2.108 | 0.631 | 0.662 | -0.516 | 19.631 | 6.109 | 0.528 | 3.326 | 0.5821 |
| Rhône | 8 | original program (Fortran PSO), run 2 | 2.089 | 0.593 | 0.646 | -0.413 | 17.537 | 5.454 | 0.528 | 2.993 | 0.5820 |
| Rhône | 8 | original program (Fortran PSO), run 3 | 0.536 | 0.514 | 0.371 | -0.218 | 19.557 | 5.539 | 0.530 | 3.192 | 0.5793 |
...
| Dischmabach | 7 | original program (Fortran PSO), run 1 | 9.108 | 1.107 | 2.552 |  | 0.000 | 10.000 | 0.582 | 1.295 | 0.6349 |
| Dischmabach | 7 | original program (Fortran PSO), run 2 | 9.115 | 1.108 | 2.555 |  | 0.000 | 10.000 | 0.582 | 1.295 | 0.6349 |
| Dischmabach | 7 | original program (Fortran PSO), run 3 | 8.805 | 1.068 | 2.461 |  | 0.001 | 9.709 | 0.582 | 1.257 | 0.6350 |
