...
| | |
|---|---|
| Date | 2026-09-25 14:26 UTC |
| pyair2stream | 0.4.0, commit 52ab73a at the start of the run |
| Mode | full |
| Run time | 69.5 minutes |
| Python | 3.11.15 |
...
**D. Calibration by the original method (PSO, authors' example settings): calibration RMSE (°C) of each run, and runs whose parameters are within 1% of their range of the published ones** ([csv](results/V2_5.csv))
...
| Mentue | 5 | 0.6664 | 0.6664, 0.6664, 0.6664 | 3 of 3 | 0.6664, 0.6664, 0.6665 | 3 of 3 | 0.6664 |
| Mentue | 7 | 0.6371 | 0.6502, 0.6638, 0.6506 | 0 of 3 | 0.6559, 0.6392, 0.6582 | 0 of 3 | 0.6336 |
| Mentue | 8 | 0.645 | 0.6589, 0.6464, 0.6585 | 0 of 3 | 0.6654, 0.6576, 0.6589 | 0 of 3 | 0.6331 |
...
| Rhône | 7 | 0.5787 | 0.5802, 0.5782, 0.5822 | 0 of 3 |  |  | 0.578 |
| Rhône | 8 | 0.5792 | 0.5788, 0.5835, 0.5800 | 0 of 3 |  |  | 0.5775 |
...
| Dischmabach | 7 | 0.6349 | 0.6349, 0.6349, 0.6357 | 2 of 3 |  |  | 0.6349 |
| Dischmabach | 8 | 0.6316 | 0.6316, 0.6316, 0.6316 | 3 of 3 |  |  | 0.6316 |

**D. Parameter values of every run, where any run differs from the published parameters** ([csv](results/V2_6.csv))
...
| Mentue | 7 | original program (Fortran PSO), run 1 | 0.993 | 0.873 | 1.010 |  | 4.885 | 3.230 | 0.595 | 0.503 | 0.6502 |
| Mentue | 7 | original program (Fortran PSO), run 2 | 0.884 | 0.917 | 1.049 |  | 6.121 | 3.964 | 0.589 | 0.631 | 0.6638 |
| Mentue | 7 | original program (Fortran PSO), run 3 | 1.079 | 0.908 | 1.059 |  | 4.793 | 3.152 | 0.599 | 0.492 | 0.6506 |
...
| Mentue | 8 | original program (Fortran PSO), run 1 | 1.155 | 1.080 | 1.247 | -0.270 | 6.002 | 3.909 | 0.596 | 0.614 | 0.6589 |
| Mentue | 8 | original program (Fortran PSO), run 2 | 1.104 | 0.926 | 1.077 | -0.157 | 4.550 | 3.011 | 0.599 | 0.468 | 0.6464 |
| Mentue | 8 | original program (Fortran PSO), run 3 | 1.329 | 1.114 | 1.299 | -0.289 | 5.567 | 3.673 | 0.598 | 0.570 | 0.6585 |
...
| Rhône | 4 | original program (Fortran PSO), run 1 | 13.031 | 0.728 | 2.940 | -0.343 |  |  |  |  | 0.9065 |
| Rhône | 4 | original program (Fortran PSO), run 2 | 13.177 | 0.737 | 2.974 | -0.350 |  |  |  |  | 0.9065 |
| Rhône | 4 | original program (Fortran PSO), run 3 | 12.896 | 0.721 | 2.910 | -0.336 |  |  |  |  | 0.9065 |
| Rhône | 4 | pyair2stream DE | 12.921 | 0.722 | 2.915 | -0.337 |  |  |  |  | 0.9065 |
| Rhône | 5 | published | 15.000 | 0.551 | 2.966 |  |  | 2.257 | 0.491 |  | 0.8707 |
| Rhône | 5 | original program (Fortran PSO), run 1 | 14.590 | 0.536 | 2.884 |  |  | 2.196 | 0.491 |  | 0.8707 |
| Rhône | 5 | original program (Fortran PSO), run 2 | 14.049 | 0.518 | 2.781 |  |  | 2.104 | 0.490 |  | 0.8708 |
| Rhône | 5 | original program (Fortran PSO), run 3 | 14.760 | 0.543 | 2.919 |  |  | 2.216 | 0.491 |  | 0.8707 |
...
| Rhône | 7 | original program (Fortran PSO), run 1 | 0.653 | 0.527 | 0.398 |  | 19.991 | 5.713 | 0.530 | 3.265 | 0.5802 |
| Rhône | 7 | original program (Fortran PSO), run 2 | 0.587 | 0.421 | 0.327 |  | 15.520 | 4.437 | 0.530 | 2.545 | 0.5782 |
| Rhône | 7 | original program (Fortran PSO), run 3 | 1.746 | 0.475 | 0.552 |  | 13.421 | 3.926 | 0.522 | 2.270 | 0.5822 |
...
| Rhône | 8 | original program (Fortran PSO), run 1 | 0.864 | 0.479 | 0.407 | -0.131 | 16.811 | 4.817 | 0.528 | 2.769 | 0.5788 |
| Rhône | 8 | original program (Fortran PSO), run 2 | 2.650 | 0.687 | 0.773 | -0.530 | 19.991 | 6.383 | 0.528 | 3.432 | 0.5835 |
| Rhône | 8 | original program (Fortran PSO), run 3 | 1.234 | 0.570 | 0.510 | -0.301 | 19.462 | 5.719 | 0.530 | 3.229 | 0.5800 |
...
| Dischmabach | 7 | original program (Fortran PSO), run 1 | 9.110 | 1.108 | 2.553 |  | 0.000 | 10.000 | 0.582 | 1.295 | 0.6349 |
| Dischmabach | 7 | original program (Fortran PSO), run 2 | 9.112 | 1.108 | 2.553 |  | 0.000 | 10.000 | 0.582 | 1.295 | 0.6349 |
| Dischmabach | 7 | original program (Fortran PSO), run 3 | 7.607 | 0.925 | 2.123 |  | 0.002 | 8.425 | 0.581 | 1.095 | 0.6357 |
| Dischmabach | 7 | pyair2stream DE | 9.109 | 1.107 | 2.552 |  | 0.000 | 10.000 | 0.582 | 1.295 | 0.6349 |

**E. With the RK4 scheme: the published parameters scored with each scheme, and recalibration with RK4 (RMSE in °C)** ([csv](results/V2_7.csv))
...
| Mentue | 5 | 0.6664 | 0.6484 | 0.6476 | 0.6 | 0.6476, 0.6476, 0.6476 | 3 of 3 |  |  |
| Mentue | 7 | 0.6371 | 1.7291 | 0.6236 | 11.2 | 0.6288, 0.6236, 0.6236 | 0 of 3 | 0.6236, 0.6236, 0.6236 | 0 of 3 |
| Mentue | 8 | 0.6450 | diverged | 0.6152 | 14.4 | 0.6185, 0.6164, 0.6165 | 0 of 3 | 0.6152, 0.6155, 0.6155 | 0 of 3 |
| Rhône | 3 | 0.9072 | 0.9177 | 0.9084 | 16.5 | 0.9084, 0.9084, 0.9084 | 0 of 3 |  |  |
| Rhône | 4 | 0.9065 | diverged | 0.9 | 18 | 0.9000, 0.9000, 0.9001 | 0 of 3 |  |  |
| Rhône | 5 | 0.8707 | diverged | 0.8755 | 29.1 | 0.8755, 0.8755, 0.8755 | 0 of 3 |  |  |
| Rhône | 7 | 0.5787 | diverged | 0.6093 | 65.2 | 0.6193, 0.6296, 0.6187 | 0 of 3 |  |  |
| Rhône | 8 | 0.5792 | diverged | 0.581 | 57.5 | 0.6163, 0.5822, 0.5964 | 0 of 3 |  |  |
...
| Dischmabach | 7 | 0.6349 | diverged | 0.6377 | 69.2 | 0.6424, 0.6385, 0.6382 | 0 of 3 |  |  |
| Dischmabach | 8 | 0.6316 | 4.7963 | 0.6057 | 50.9 | 0.6079, 0.6057, 0.6058 | 0 of 3 |  |  |

**E. Mentue: parameter values from calibration with RK4** ([csv](results/V2_8.csv))
...
| Mentue | 5 | original program (Fortran PSO) with RK4, run 1 | 3.168 | 0.711 | 1.065 |  |  | 1.646 | 0.585 |  | 0.6476 | 0.7 |
| Mentue | 5 | original program (Fortran PSO) with RK4, run 2 | 3.128 | 0.704 | 1.053 |  |  | 1.621 | 0.585 |  | 0.6476 | 0.6 |
| Mentue | 5 | original program (Fortran PSO) with RK4, run 3 | 3.170 | 0.712 | 1.065 |  |  | 1.645 | 0.585 |  | 0.6476 | 0.7 |
| Mentue | 7 | published | 0.999 | 0.772 | 0.905 |  | 3.487 | 2.312 | 0.598 | 0.361 | 0.6371 |  |
| Mentue | 7 | DE with RK4 | 0.912 | 0.623 | 0.741 |  | 1.764 | 1.189 | 0.607 | 0.182 | 0.6236 | 11.2 |
| Mentue | 7 | original program (Fortran PSO) with RK4, run 1 | 1.157 | 0.701 | 0.846 |  | 1.584 | 1.138 | 0.611 | 0.164 | 0.6288 | 11.7 |
| Mentue | 7 | original program (Fortran PSO) with RK4, run 2 | 0.927 | 0.628 | 0.747 |  | 1.753 | 1.185 | 0.607 | 0.181 | 0.6236 | 11.3 |
| Mentue | 7 | original program (Fortran PSO) with RK4, run 3 | 0.947 | 0.629 | 0.750 |  | 1.741 | 1.187 | 0.607 | 0.180 | 0.6236 | 11.2 |
...
| Mentue | 8 | original program (Fortran PSO) with RK4, run 1 | 0.854 | 0.689 | 0.806 | 0.168 | 2.998 | 1.968 | 0.599 | 0.308 | 0.6185 | 16.3 |
| Mentue | 8 | original program (Fortran PSO) with RK4, run 2 | 0.933 | 0.698 | 0.822 | 0.145 | 2.535 | 1.663 | 0.604 | 0.262 | 0.6164 | 15.2 |
| Mentue | 8 | original program (Fortran PSO) with RK4, run 3 | 0.876 | 0.680 | 0.799 | 0.149 | 2.732 | 1.797 | 0.601 | 0.281 | 0.6165 | 15.3 |
