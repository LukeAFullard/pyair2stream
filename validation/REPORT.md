...
| | |
|---|---|
| Date | 2026-09-25 07:52 UTC |
| pyair2stream | 0.4.0, commit 69de97c at the start of the run |
| Mode | full |
...
**C. Recalibrated vs published parameters (active parameters, in order a1..a8)** ([csv](results/V2_3.csv))

| river | version | published parameters | recalibrated parameters | largest difference (% of range) | match | calibration RMSE, published | calibration RMSE, recalibrated | local search from published | seed 2 vs seed 1 (% of range) | validation RMSE, published | validation RMSE, recalibrated |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Mentue | 3 | 0.953 0.521 0.639 | 0.953 0.521 0.639 | 0 | yes | 0.7927 | 0.7927 |  |  |  |  |
| Mentue | 4 | 0.898 0.482 0.593 0.200 | 0.898 0.481 0.593 0.200 | 0.02 | yes | 0.785 | 0.785 |  |  |  |  |
| Mentue | 5 | 3.075 0.668 1.010 1.616 0.583 | 3.074 0.668 1.010 1.615 0.583 | 0.01 | yes | 0.6664 | 0.6664 |  |  |  |  |
| Mentue | 7 | 0.999 0.772 0.905 3.487 2.312 0.598 0.361 | 0.920 0.680 0.800 2.669 1.776 0.601 0.278 | 5.36 | no | 0.6371 | 0.6336 | 0.6336 | 0 | 0.7784 | 0.7793 |
| Mentue | 8 | 1.067 0.911 1.060 -0.158 4.387 2.868 0.599 0.450 | 0.890 0.654 0.770 0.066 2.552 1.695 0.601 0.266 | 11.73 | no | 0.645 | 0.6331 | 0.6331 | 0.01 | 0.7809 | 0.7791 |
| Rhône | 3 | 11.366 0.635 2.565 | 10.791 0.603 2.436 | 2.87 | no | 0.9072 | 0.9073 | 0.9072 | 2.88 | 1.048 | 1.048 |
| Rhône | 4 | 12.912 0.722 2.913 -0.337 | 12.921 0.722 2.915 -0.337 | 0.04 | yes | 0.9065 | 0.9065 |  |  |  |  |
| Rhône | 5 | 15.000 0.551 2.966 2.257 0.491 | 15.000 0.551 2.966 2.257 0.491 | 0 | yes | 0.8707 | 0.8707 |  |  |  |  |
| Rhône | 7 | 0.682 0.457 0.365 16.727 4.770 0.531 2.742 | 0.596 0.390 0.313 14.063 4.016 0.529 2.311 | 13.32 | no | 0.5787 | 0.578 | 0.578 | 0.01 | 0.7391 | 0.7396 |
| Rhône | 8 | 0.560 0.509 0.374 -0.191 19.220 5.435 0.530 3.139 | 0.464 0.316 0.251 0.325 11.552 3.302 0.529 1.896 | 38.34 | no | 0.5792 | 0.5775 | 0.5778 | 0 | 0.7392 | 0.7395 |
| Dischmabach | 3 | 6.440 0.984 2.477 | 6.508 0.995 2.504 | 0.34 | yes | 0.9369 | 0.9369 |  |  |  |  |
| Dischmabach | 4 | 9.906 1.500 3.785 -0.725 | 9.906 1.500 3.785 -0.725 | 0 | yes | 0.9328 | 0.9328 |  |  |  |  |
| Dischmabach | 5 | 15.000 1.131 4.617 7.660 0.588 | 15.000 1.133 4.620 7.663 0.588 | 0.03 | yes | 0.7407 | 0.7407 |  |  |  |  |
| Dischmabach | 7 | 9.108 1.107 2.552 0.000 10.000 0.582 1.295 | 9.109 1.107 2.552 0.000 10.000 0.582 1.295 | 0 | yes | 0.6349 | 0.6349 |  |  |  |  |
| Dischmabach | 8 | 9.442 1.159 2.658 -0.530 0.000 10.000 0.582 1.305 | 9.442 1.159 2.658 -0.530 0.000 10.000 0.582 1.305 | 0 | yes | 0.6316 | 0.6316 |  |  |  |  |
...
**Parameter intervals from leaving one year out, 12 replicates per case: share containing the true value (90% intervals)** ([csv](results/V4_5.csv))

| case | raw spread of the leave-one-year-out fits | jackknife | MCMC | median width, jackknife / MCMC | median width, raw spread / MCMC |
|---|---|---|---|---|---|
| B | 55% | 87% | 85% | 1.4 | 0.5 |
| D | 56% | 83% | 75% | 1.8 | 0.6 |

**DE-MCMC (6000 steps) and DE-CV-MCMC (7000 steps) on the Mentue, version 8, same seed** ([csv](results/V4_6.csv))

| parameter | DE-MCMC 90% interval | DE-CV-MCMC 90% interval | largest difference (share of width) |
|---|---|---|---|
| a1 | 0.933 to 1.303 | 0.933 to 1.303 | 0.1% |
| a2 | 0.769 to 0.853 | 0.768 to 0.853 | 0.4% |
| a3 | 0.910 to 1.013 | 0.910 to 1.013 | 0.8% |
| a4 | -0.101 to 0.003 | -0.101 to 0.003 | 0.2% |
| a5 | 4.141 to 5.212 | 4.137 to 5.198 | 1.3% |
| a6 | 2.893 to 3.605 | 2.896 to 3.601 | 0.6% |
| a7 | 0.586 to 0.595 | 0.586 to 0.595 | 1.5% |
| a8 | 0.428 to 0.533 | 0.428 to 0.532 | 0.9% |
...
> Leaving one year out and refitting (as cross-validation does) shows how much the parameters move between years, but that spread is not itself a confidence interval: every refit shares most of its data with the others, so the raw spread contained the true values only 55% (version 5) and 56% (version 8) of the time. Scaled correctly (the delete-one-year jackknife), it gave 87% for version 5, with intervals about 1.4 times as wide as MCMC's. For version 8 the jackknife intervals were about 2 times as wide as MCMC's yet contained the truth only 83% of the time: along version 8's ridge of equally good fits, each refit lands somewhere different. Neither method gives dependable intervals for individual version 8 parameters.

> DE-CV-MCMC uses the spread of the leave-one-year-out fits only to scatter the sampler's starting points. It gave the same parameter intervals as DE-MCMC to within 1.5% of their width (table above).
