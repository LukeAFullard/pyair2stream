...
def main():
    ...
    python_cal_df = pd.read_csv('examples/validation/Switzerland/output_8/2_PSO_NSE_DAV_cc_1d.csv')

    fortran_val_df = pd.read_csv('fortran/src/output_8/3_PSO_NSE_DAV_2327_cv_1d.out', sep=r'\s+', header=None, skiprows=1)
    python_val_df = pd.read_csv('examples/validation/Switzerland/output_8/3_PSO_NSE_DAV_cv_1d.csv')
