...
with open('examples/validation/Switzerland/report.md', 'a') as report:
    ...
    report.write("Following the initial evaluation, a high-intensity Differential Evolution pass (100 particles, 3000 runs) was executed to ascertain whether a stronger global search bounds the parameters closer to literature values, and to evaluate absolute convergence limits of the model equifinality.\n\n")
