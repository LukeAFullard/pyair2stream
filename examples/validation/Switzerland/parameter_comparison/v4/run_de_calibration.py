...
lit_params = {
    "MAH": [0.935, 0.504, 0.620, 0.212, 0.0, 0.0, 0.0, 0.0],
    "SIO": [9.303, 0.531, 2.110, -0.251, 0.0, 0.0, 0.0, 0.0],
    "DAV": [5.917, 0.929, 2.285, -0.147, 0.0, 0.0, 0.0, 0.0]
}
...
v_dir = 'examples/validation/Switzerland/parameter_comparison/v4'
...
def run_station(station_info):
    ...
    plt.title(f'v4 DE vs Literature Parameters - {station}')
...
with open(report_path, 'w') as report:
    report.write("# Version 4 Parameter Comparison\n\n")
    ...
    if not hit_bound:
        report.write("- None of the active parameters explicitly hit the tight upper or lower bounds provided, indicating the search space bounds were sufficiently wide for version 4.\n")
    report.write("\n")
