...
lit_params = {
    "MAH": [3.149, 0.708, 1.059, 0.0, 0.0, 1.632, 0.585, 0.0],
    "SIO": [9.172, 0.351, 1.834, 0.0, 0.0, 1.303, 0.485, 0.0],
    "DAV": [7.486, 0.651, 2.768, 0.0, 0.0, 7.044, 0.607, 0.0]
}
...
v_dir = 'examples/validation/Switzerland/parameter_comparison/v5'
...
def run_station(station_info):
    ...
    plt.title(f'v5 DE vs Literature Parameters - {station}')
...
with open(report_path, 'w') as report:
    ...
    if not hit_bound:
        report.write("- None of the active parameters explicitly hit the tight upper or lower bounds provided, indicating the search space bounds were sufficiently wide for version 5.\n")
    report.write("\n")
